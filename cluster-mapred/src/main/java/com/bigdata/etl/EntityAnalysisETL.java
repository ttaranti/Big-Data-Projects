       ...
       // cluster artifacts
        ...
        while (tokenStore.hasNext()) {
            ...
            if(dirtyLine.equals(END_CLUSTER_FLAG) ) {
                ...
                is_CLUSTER_LINE = false;
            // DEBUG
            // System.out.println("END_CLUSTER_FLAG size: " + inputValues.size()+ " ClusterId: "+entityId+ " for line: "+token_counter);
            ...
            if( SET_CLUSTER_FLAG  && is_CLUSTER_LINE ) {
                ...
                entityId =  line[0];
          //      System.out.println("SET_CLUSTER_FLAG   && is_CLUSTER_LINE " + entityId+ "for line "+token_counter);
